...
const VideoDetails = () => {
  ...
  // when we click on a course it takes us to view course page and a video is displayed to display that video on first render we use this 
  useEffect (() => {
  ...
  // if we are in first lecture we cannot go to next so this func 
