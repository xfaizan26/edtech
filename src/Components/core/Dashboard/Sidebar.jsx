    ...
    <div className=' text-white bg-richblack-800'>
        ...
        h-[calc[100vh-3.5rem)] bg-richblack-800 py-10'>
            ...
            <div className='flex flex-col'>
                { //if the type of link and user type are not same then we render null (nothing) else we render the links
        ...
        {/* if confirmation modal is null then it is not rendered but when it is not null than confirmationModal is rendered */}
