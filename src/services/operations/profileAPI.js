...
export async function getUserCourses(token,dispatch){
    ...
    try {
      ...
      const response = await apiConnector(
        ...
        null,
        //difficulty faced the spelling of authorization here and in backend were different therefore it was not working and a lot of time was spent to find out this mistake
        {
