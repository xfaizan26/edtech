...
//elematch compares for eq here which stands for equality 
...
exports.getAverageRating = async (req, res) => {
  try {
    ...
    const result = await RatingAndReview.aggregate([
      {
        $match: {
          ...
          //the type of courseid is string from req body therefore we convert to object as it is present as object
        },
      },
      {
        $group: {
    ...
    //grp by null therefore into sinle unit 
...
exports.getAllRatingReview = async (req, res) => {
  try {
    //rating and review of all the courses and not specific course
